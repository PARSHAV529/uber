...
function setDetails(data) {
  ...
  document.getElementById(
    "driver-name"
  ).innerHTML = `${dd.first_name} ${dd.last_name}`;
  ...
  document.getElementById("vehicle-type").value = `${vd.type}`;

  document.getElementById("vehical-approved").value = `${dd.vehicle_approved}`;

  document.getElementById("capacity").value = `${vd.capacity}`;

  document.getElementById("colour").value = `${vd.colour}`;

  document.getElementById(
    "insurance-exp-date"
  ).value = `${vd.insurance_exp_date}`;

  document.getElementById("number-plate").value = `${vd.number_plate}`;

  document.getElementById("puc-exp-date").value = `${vd.puc_exp_date}`;

  document.getElementById("DOB").value = `${dd.DOB}`;

  document.getElementById("driver-email").value = `${dd.email}`;

  document.getElementById("document-status").value = `${dd.document_status}`;

  document.getElementById("phone-number").value = `${dd.phone_number}`;

  document.getElementById("dl-number").value = `${dd.dl_number}`;

  document.getElementById("dl-exp-date").value = `${dd.dl_exp_date}`;
}
